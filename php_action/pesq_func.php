...
frm de pesquisa
 ...
 -->
          ...
          <!-- Topbar Search -->
         <?php 
         $pesq = "SELECT * FROM t_funcionario WHERE nome LIKE '%pesquisar%'";
           ...
           <div class="row">
             ...
             <div class="col-md-3">              
                  <a class="btn btn-primar btn-block" href="../cad_fun.php" >Novo funcionarios</a>           
             </div> 
          </div>        
              ...
              <div class="col-md-12" style="padding-bottom: 10px">
                  ...
                  //  $sql = "SELECT * FROM t_funcionario LIMIT 5";
